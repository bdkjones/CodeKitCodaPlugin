...
@interface VDKCodeKitCodaPlugin : NSObject <CodaPlugIn>
{
    ...
    // are sent to us virtually simultaneously. Keep paths we notify CodeKit about in this set for 5 seconds so we don't rapid-fire AppleScript events for the same path.
    //
